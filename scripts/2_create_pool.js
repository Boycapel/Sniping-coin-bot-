...
module.exports = async function (callback) {
    ...
    const FRS = await Token.deployed()

    const FRSAmount = web3.utils.toWei('250', 'ether')
    ...
    console.log(`Approving FRS...\n`)

    await FRS.approve(uRouter._address, FRSAmount, { from: deployer })
